    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body ">
          <div class="row">
            <div class="col-lg-6">
                <h2 class="login-box-msg h2 text-left text-primary px-0"><b>User Details</b></h2>
            </div>
            @if($user != '')
            <div class="col-lg-6 text-right">
                <a href="{{ url('users/edit/'.$user['id'])}}" class="btn btn-primary rounded-0"><span class="fas fa-pen mr-2"></span>Edit User</a>
            </div>
            @endif
          </div>
            @if (session('status'))
          ...
          <form action="{{ url('users/update/'.$user->id) }}" method="post">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <select class="custom-select @error('role') is-invalid @enderror" name="role" id="role" disabled>
