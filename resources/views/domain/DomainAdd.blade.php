...
@section('content')
    <div class="col-lg-12 py-3">
      ...
      <div class="card">
        <div class="card-body ">
          <h2 class="login-box-msg h2 text-center text-primary px-0"><b>Create New Domain</b></h2>
                @if (session('status'))
          ...
          <form action="{{ url('domain/input') }}" method="post">
              ...
              <div class="row">
                ...
                <div class="col-12 text-center">
                  <button type="submit" class="btn btn-primary form-control my-3 w-25 ">CREATE DOMAIN</button>
                </div>
              </div>
          </form>
        </div>
